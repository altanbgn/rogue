...
namespace Rogue.Player
{
  ...
  public class PlayerMovement : MonoBehaviour, IAction
  {
    ...
    private void CheckOnGround()
    {
      ...
      Collider2D[] colliders = Physics2D.OverlapCircleAll(_groundCheck.position, .2f, _groundLayerMask);
    ...
    private void CheckOnWall()
    {
      ...
      Collider2D[] colliders = Physics2D.OverlapBoxAll(_wallCheck.position, new Vector2(1f, 2f), 0f, _wallLayerMask);
    ...
    private void Move()
    {
      ...
      {
        // Moves the character
        Vector2 targetVelocity = new Vector2(_movementDirection * _attributes.movementSpeed.GetValue(), _rigidbody.velocity.y);
